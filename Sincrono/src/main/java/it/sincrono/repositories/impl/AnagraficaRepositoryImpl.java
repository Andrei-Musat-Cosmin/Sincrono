		...
		if (anagraficaDto != null) {
			...
			if (anagraficaDto.getContratto() != null) {
				...
				if (anagraficaDto.getContratto().getLivelloContratto() != null
						&& anagraficaDto.getContratto().getLivelloContratto().getLivello() != null
						&& anagraficaDto.getContratto().getLivelloContratto().getLivello() != "") {
			...
			for (Iterator<Object> it = list.iterator(); it.hasNext();) {
				...
				if (anagraficaDto.getCommesse().get(0) != null) {
					...
					if (commessa != null && commessa.getAziendaCliente() != "") {
						subString += "AND c.azienda_cliente LIKE '" + commessa + "'";
					}
					if (commessa.getAttesaLavori() != null) {
						subString += "AND c.azienda LIKE '" + anagraficaDto.getCommesse().get(0).getAttesaLavori()
								+ "'";
					}
				...
				currentAnagraficaDto.setCommesse(new ArrayList<Commessa>());
				for (Iterator<Object> iterator = listCommessa.iterator(); iterator.hasNext();) {
					...
					currentAnagraficaDto.getCommesse().add(commessa);
