...
public class Anagrafica {
	...
	public Anagrafica(Integer id, Utente utente, String aziendaTipo, String cognome, String nome, String codiceFiscale,
			String comuneDiNascita, Date dataDiNascita, String residenza, String domicilio, String cellularePrivato,
			String celllulareAziendale, String mailPrivata, String mailAziendale, String mailPec, String titoliDiStudio,
			String altriTitoli, Boolean coniugato, Boolean figliaCario) {
		super();
		this.id = id;
		this.utente = utente;
